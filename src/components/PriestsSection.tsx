...
const orders: Order[] = [
  ...
  },
  {
    ...
    god: 'Тот',
    icon: 'Moon',
    role: 'Предсказания и запись',
    eyebrow: 'Жрецы Тота',
    heading: 'Жрецы Джехути — те, кто читает ход до того, как он сделан',
    intro:
      'Они не сражаются и не лечат: они смотрят вперёд. Механика предсказаний позволяет объявить событие круга заранее — и получить награду, если стол пойдёт по написанному.',
    priests: [
      {
        id: 'thoth-male',
        variant: 'Мужская версия',
        title: 'Хем-нечер Джехути',
        image: 'https://cdn.poehali.dev/projects/bfa830f0-f2cc-4b64-9f77-de1d82d4eb1b/files/3ef60ad0-7a20-432d-a54e-3e9640aa9891.jpg',
        scene: 'https://cdn.poehali.dev/projects/bfa830f0-f2cc-4b64-9f77-de1d82d4eb1b/files/3901a9d2-19a6-4f99-88fc-5d1990cd55df.jpg',
        quote: 'Я не угадываю. Я записываю раньше, чем это случится.',
        description:
          'Хранитель библиотеки и счётчик ходов. В начале круга он пишет закрытое предсказание: кто нарушит союз, кто войдёт в логово, чья ставка ляжет на весы. Сбылось — стол платит ему пером.',
        abilities: [
          { icon: 'ScrollText', name: 'Закрытое пророчество', text: 'В начале круга записывает одно событие. Сбылось — получает перо истины, не сбылось — теряет ход.' },
          { icon: 'Eye', name: 'Взгляд ибиса', text: 'Смотрит две верхние карты колоды заданий и возвращает их в любом порядке.' },
          { icon: 'RotateCcw', name: 'Правка протокола', text: 'Раз за партию отменяет последнее действие любого игрока, включая своё.' },
        ],
        gear: ['Маска ибиса', 'Тростниковое перо', 'Оплечье из лазурита', 'Посох полумесяца'],
      },
      {
        id: 'thoth-female',
        variant: 'Женская версия',
        title: 'Хемет-нечер Джехутет',
        image: 'https://cdn.poehali.dev/projects/bfa830f0-f2cc-4b64-9f77-de1d82d4eb1b/files/35b9ab4b-6590-4661-88df-bfbe5ecccb91.jpg',
        scene: 'https://cdn.poehali.dev/projects/bfa830f0-f2cc-4b64-9f77-de1d82d4eb1b/files/914979da-f22a-4475-bdc0-f3e5c8727734.jpg',
        quote: 'Небо уже решило. Я лишь читаю вслух.',
        description:
          'Звездочёт и толковательница знамений. Она открывает предсказание всему столу — и этим меняет его: игроки начинают ходить против пророчества, а она зарабатывает как раз на их страхе.',
        abilities: [
          { icon: 'Stars', name: 'Открытое знамение', text: 'Объявляет предсказание вслух. Если стол его нарушил — забирает по карте у каждого, кто помешал.' },
          { icon: 'Moon', name: 'Карта неба', text: 'В начале круга видит, какую роль примет дракон в логове.' },
          { icon: 'Hourglass', name: 'Отложенный час', text: 'Переносит своё движение на следующий ход и получает двойное перемещение.' },
        ],
        gear: ['Маска ибиса', 'Диск-астролябия', 'Серебряный амулет', 'Свиток созвездий'],
      },
    ],
  },
];
